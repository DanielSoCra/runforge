...
- **Override pins drift:** overrides can mask future legit upgrades; mitigation = record each override's advisory ID in `docs/security-overrides.md` (JSON forbids comments).
