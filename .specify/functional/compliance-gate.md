...
- This gate **composes with and overrides** the earned-trust risk-class ramp (FUNC-AC-MERGE-DECISION): wherever this gate requires the Operator, no risk class can earn an autonomous proceed, and the gate is the ramp's first, never-earned-away line.
