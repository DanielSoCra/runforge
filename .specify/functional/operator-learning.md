...
- A learned bias that proves wrong must be reversible wherever it took effect, falling back to the prior, more cautious behavior; the platform never learns its way into a state it cannot back out of.
