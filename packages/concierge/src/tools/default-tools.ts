...
const DEFAULT_TOOL_SPECS: DefaultToolSpec[] = [
  {
    name: 'ac_run',
    description: 'Start an auto-claude run for one issue',
  ...
  {
    name: 'ac_status',
    description: 'Read the auto-claude daemon status',
    subsystem: 'auto-claude',
    blastRadius: 'safe',
    governingSpecId: 'FUNC-AC-CONTROL-PLANE',
  ...
  {
    name: 'ac_pause',
    description: 'Pause the auto-claude daemon',
    subsystem: 'auto-claude',
    blastRadius: 'medium',
    governingSpecId: 'FUNC-AC-CONTROL-PLANE',
    argsSchema: EMPTY_OBJECT_SCHEMA,
  ...
  {
    name: 'ac_unstuck',
    description: 'Retry one stuck auto-claude issue',
    subsystem: 'auto-claude',
    blastRadius: 'medium',
    governingSpecId: 'FUNC-AC-CONTROL-PLANE',
    argsSchema: ISSUE_SCHEMA,
  },
  {
    ...
    description: 'Merge an approved auto-claude change to main',
    subsystem: 'auto-claude',
    blastRadius: 'high',
    governingSpecId: 'FUNC-AC-CONTROL-PLANE',
    argsSchema: ISSUE_SCHEMA,
