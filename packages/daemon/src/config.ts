...
export const ConfigSchema = z.object({
  ...
  coordination: z
    .object({
      ...
      poInteractiveTimeout: z.number().int().min(60).default(1800),
      poSharedStateRetentionDays: z.number().int().min(1).default(7),
      poMaxWriteRetries: z.number().int().min(1).default(3),
